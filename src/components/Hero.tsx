export default function Hero() {
    return (
        <section className="hidden sm:flex mt-16 flex-col items-center justify-center h-[60vh] rounded-2xl shadow-lg text-center">
            <h1 className="text-4xl md:text-4xl font-bold text-gray-900 mb-4">
                Find your next stay
            </h1>
            <p className="text-lg md:text-lg text-gray-600 mb-6 max-w-xl">
